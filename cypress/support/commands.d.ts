...
declare global {
  ...
  namespace Cypress {
    interface Chainable {
       ...
       */
      loginWalletWith(walletAccessType: WalletAccessType, keyName?: string, network?: string): Chainable<Element>
      /**
       ...
       */
      waitUntil(alias: string, untilFunc: (intercept: Interception) => boolean): Chainable<Element>
    }
  }
}