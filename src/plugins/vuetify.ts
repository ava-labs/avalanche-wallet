...
import {
  ...
  faSync, faExclamationTriangle, faPrint, faQrcode, faCopy, faKey, faFileExcel, faList
...
library.add(
    ...
    faMinus, faSync, faExclamationTriangle, faPrint, faQrcode, faCopy, faKey, faFileExcel, faList
);
