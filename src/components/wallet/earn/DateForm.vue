<template>
    <div class="dates">
        <div>
            ...
            <datetime v-model="localStart" type="datetime" :min-datetime="startDateMin" :max-datetime="startDateMax"></datetime>
        </div>
        <div>
            <label>{{$t('earn.validate.duration.end')}} <span @click="maxoutEndDate">Max</span></label>
            <datetime v-model="localEnd" type="datetime" :min-datetime="endDateMin" :max-datetime="endDateMax"></datetime>
        </div>
    </div></template>
<script lang="ts">
