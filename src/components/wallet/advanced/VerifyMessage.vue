<template>
    <div>
        ...
        <p style="margin-bottom: 14px !important;">{{$t('advanced.verify.desc')}}</p>
        <div>
        ...
        <p class="err">{{error}}</p>
        <v-btn class="button_secondary" block small depressed @click="verify" :disabled="!canSubmit">{{$t('advanced.verify.submit')}}</v-btn>
