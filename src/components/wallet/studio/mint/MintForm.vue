...
import { NFTMintOutput, NFTTransferOutput, UTXO } from '@c4tplatform/avalanche/dist/apis/avm'
...
import { PayloadBase, URLPayload, UTF8Payload, JSONPayload } from '@c4tplatform/avalanche/dist/utils'
